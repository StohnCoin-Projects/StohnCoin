...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/stohn.conf}
...
then
  ...
  echo -e "To safely generate a stohn.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example stohn.conf file in share/examples/'
