...
static const char* qt_argv = "stohncoin-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if (success) {
        ...
        // stohncoin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse stohn.conf, determine network, switch to network specific
    ...
    // stohncoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
