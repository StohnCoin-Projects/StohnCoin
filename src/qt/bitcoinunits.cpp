...
{
    switch (unit) {
    case Unit::BTC: return QString("SOH");
    case Unit::mBTC: return QString("mSOH");
    case Unit::uBTC: return QString::fromUtf8("µSOH (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Stohns");
    case Unit::mBTC: return QString("Milli-Stohns (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Stohns (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
