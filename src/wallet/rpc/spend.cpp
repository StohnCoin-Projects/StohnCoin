    ...
    return RPCHelpMan{"sendtoaddress",
        ...
        HELP_REQUIRING_PASSPHRASE,
                ...
                RPCExamples{
                    ...
                    "\nSend 0.1 SOH with a fee rate of 1.1 " + CURRENCY_ATOM + "/vB, subtract fee from amount, BIP125-replaceable, using positional arguments\n"
                    ...
                    "\nSend 0.5 SOH with a fee rate of 25 " + CURRENCY_ATOM + "/vB using named arguments\n"
...
RPCHelpMan send()
{
    return RPCHelpMan{"send",
        ...
        "Send 0.2 SOH with a fee rate of 1.1 " + CURRENCY_ATOM + "/vB using positional arguments\n"
        + HelpExampleCli("send", "'{\"" + EXAMPLE_ADDRESS[0] + "\": 0.2}' null \"unset\" 1.1\n") +
        "Send 0.2 SOH with a fee rate of 1 " + CURRENCY_ATOM + "/vB using the options argument\n"
        + HelpExampleCli("send", "'{\"" + EXAMPLE_ADDRESS[0] + "\": 0.2}' null \"unset\" null '{\"fee_rate\": 1}'\n") +
        "Send 0.3 SOH with a fee rate of 25 " + CURRENCY_ATOM + "/vB using named arguments\n"
